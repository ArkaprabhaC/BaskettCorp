...
class RegisterController extends Controller
{
    ...
    */
    ...
    public function showRegistrationForm()
    {
        ...
        return view('vendor.auth.register')->with('states',$indian_states)->with('cities',$indian_cities);
    }
    ...
    protected function register(Request $request){
        ...
        if($request->get('chk_password') === $request->get('password')){
            ...
            if (Auth::guard('vendor')->attempt(['email' => $request->get('email'), 'password' => $password])) {
                ...
                return redirect('/vendor/register')->with('alert','Oops. Something happened. Try again later or contact customer support.');
            }
        }else{
