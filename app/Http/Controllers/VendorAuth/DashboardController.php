...
class DashboardController extends Controller
{
    protected function showDashboardPage(){
        if(Auth::guard('vendor')->check()){
            return view('vendor.dashboard.add_product');
        }else{
            return redirect('/');
        }
    }
    ...
    protected function showRemoveProductPage(){
        
        if(Auth::guard('vendor')->check()){
            $vendor_id = Auth::guard('vendor')->user()->id;
            $products = Product::where('vendorID',$vendor_id)->get()->toArray();
            //dd($products[0]['id']);
            return view('vendor.dashboard.remove_product')->with('products',$products);
        }else{
            return redirect('/');
        }
    }
    ...
    protected function removeProduct(Request $request){
        ...
        if(Auth::guard('vendor')->check()){
            $product_img=Product::where('id',$request->product_id)->first(['image']);
            //dd($product_img['image']);
            unlink(public_path("uploads/products/".$product_img['image']));
            Product::where('id',$request->product_id)->delete();
            
            return redirect('/vendor/dashboard/removeproduct')->with('alert-success', 'You have deleted your product');
        }
        
    }

    protected function showSettingsPage(Request $request){
        ...
        if(Auth::guard('vendor')->check()){
            ...
            return view('vendor.dashboard.settings')->with('vendor',$vendor)->with('states',$indian_states)->with('cities',$indian_cities);
    ...
    protected function updateProfile(Request $request){
        ...
        return redirect('/vendor/dashboard/settings');
    }
