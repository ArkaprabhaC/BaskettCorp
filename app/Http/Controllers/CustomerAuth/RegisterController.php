...
class RegisterController extends Controller
{
    ...
    */
    ...
    public function showRegistrationForm()
    {
        ...
        return view('customer.auth.register')->with('states',$indian_states)->with('cities',$indian_cities);
    }
    ...
    protected function register(Request $request)
    {
        ...
        if($request->get('chk_password') === $request->get('password')){
            ...
            if (Auth::guard('customer')->attempt(['email' => $request->get('email'), 'password' => $password])) {
                ...
                //echo "Oops. Something happened. Try again later or contact customer support.";
                return redirect('/customer/register')->with('alert','Oops. Something happened. Try again later or contact customer support.');
            }
        }else{
